...
if ispc
    ...
    mex('lbfgsb_wrapper.c',VFLAG{:},'-largeArrayDims','-UDEBUG',...
        ['-I',SRC_DIR], SRC{:} );
    mex('lbfgsb2_wrapper.c',VFLAG{:},'-largeArrayDims','-UDEBUG',...
		'-O','CFLAGS="\$CFLAGS -std=c99"',...
        ['-I',SRC_DIR], SRC2{:} );
else
    mex('lbfgsb_wrapper.c',VFLAG{:},'-largeArrayDims','-lm','-UDEBUG',...
        ['-I',SRC_DIR], SRC{:} );
	mex('lbfgsb2_wrapper.c',VFLAG{:},'-largeArrayDims','-lm','-UDEBUG',...
		'-O','CFLAGS="\$CFLAGS -std=c99"',...
        ['-I',SRC_DIR], SRC2{:} );
